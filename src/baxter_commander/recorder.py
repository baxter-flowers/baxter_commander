...
class Recorder:
    def __init__(self, side, max_points=1000000):
        """
        ...
        """
        self._side = side
        self._joints = map(lambda j: self._side + '_' + j, ['s0', 's1', 'e0', 'e1', 'w0', 'w1', 'w2'])
